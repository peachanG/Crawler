...
parser.add_argument('--id_text', '-id', type=str, default='data/id_list.txt',
                    help='config(yaml) file path')
parser.add_argument('--token', '-t', type=str, default='./twitter_token.yml',
                    help='twitter account token file path')
parser.add_argument('--output_data_text', '-o', type=str, default='results',
                    help='reply data text path')
